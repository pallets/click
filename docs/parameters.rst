...
On each principle type you can specify :ref:`parameter-types`. Specifying these types helps Click add details to your help pages and helps with the handling of those types.
