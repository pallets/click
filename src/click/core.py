...
class Parameter:
    ...
    def to_info_dict(self) -> dict[str, t.Any]:
        ...
        return {
            ...
            # XXX Normalize the default to None if UNSET. This is acceptable for
            # now as to_info_dict() has been designed to be used for documentation
            # purposes, and UNSET is not a user-facing value.
            # TODO: Make UNSET a first class citizen in Click 9.0, remove this
            # normalization and returns self.default as-is.
    ...
    def resolve_envvar_value(self, ctx: Context) -> str | None:
        ...
        for envvar in envvars:
            ...
            # Absence of value is interpreted as an environment variable that is not
            # set, so skip it.
            if not raw_value:
                continue
...
class Option(Parameter):
    ...
    def to_info_dict(self) -> dict[str, t.Any]:
        ...
        info_dict.update(
            ...
            # XXX Normalize the flag_value to None if UNSET. This is acceptable for
            # now as to_info_dict() has been designed to be used for documentation
            # purposes, and UNSET is not a user-facing value.
            # TODO: Make UNSET a first class citizen in Click 9.0, remove this
            # normalization and returns self.flag_value as-is.
    ...
    def value_from_envvar(self, ctx: Context) -> str | cabc.Sequence[str] | bool | None:
        """
